...
>>>>>>> e53f5993c9502894a9ff046eb5d7c5cb0888e7a3
...
function inicializarMapa() {
  ...
  map = L.map('map', { zoomControl: false }).setView(posPadrao, 15);
  ...
  markerEntregador = L.marker(posPadrao, { icon: iconeMotoboy }).addTo(map);
}
...
function iniciarRastreamentoTempoReal() {
  ...
  navigator.geolocation.watchPosition(
    function (posicao) {
      ...
      map.panTo(novaPosicao, { animate: true, duration: 0.8 });
